...
const wattHint       = document.getElementById("wattHint");
...
function updatePreview() {
  ...
  const watts  = DEVICE_RATINGS[device] || 100;
  const kwh    = ((watts / 1000) * hours).toFixed(3);
  wattHint.textContent = `Wattage: ${watts} W`;
  kwhPreview.textContent = hours > 0 ? `Estimated: ${kwh} kWh` : "Estimated: — kWh";
}
